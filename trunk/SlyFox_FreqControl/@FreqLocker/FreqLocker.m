classdef FreqLocker < hgsetget
    ...
    methods
        function obj = FreqLocker(top,f)
            ...
            obj.myPID4 = obj.myPID4gui.myPID;
...
%                         end
                        ...
                        deltaT4 = str2double(get(obj.myPID4gui.myDeltaT, 'String'));
                            switch seqPlace
                                ...
                                case 5
                                        if deltaT3 == 0
                                            calcCorr3 = obj.myPID3.calculate(calcErr3, time);
                                        else
                                            calcCorr3 = obj.myPID3.calculate(calcErr3, -deltaT3);
                                        end
                                ...
                                case 7
                                        if deltaT4 == 0
                                            calcCorr4 = obj.myPID4.calculate(calcErr4, time);
                                        else
                                            calcCorr4 = obj.myPID4.calculate(calcErr4, -deltaT3);
                                        end
...
% 'Frequency', 'Norm', 'GndState', 'ExcState', 'Background', 'TStamp', 'BLUEGndState', 'BLUEBackground', 'BLUEExcState'
                    ...
                    if get(obj.myPID3gui.mySaveLog, 'Value')
                    ...
                    if get(obj.myPID4gui.mySaveLog, 'Value')
...
% 'Frequency', 'Norm', 'GndState', 'ExcState', 'Background', 'TStamp', 'BLUEGndState', 'BLUEBackground', 'BLUEExcState'
        ...
        function updatePIDvalues(obj)
            ...
            obj.myPID4.myKp = str2double(get(obj.myPID4gui.myKp, 'String'));
            obj.myPID4.myKi = str2double(get(obj.myPID4gui.myKi, 'String'));
            obj.myPID4.myKd = str2double(get(obj.myPID4gui.myKd, 'String'));
