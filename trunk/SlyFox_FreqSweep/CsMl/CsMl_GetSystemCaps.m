...
% 
% The available capabilities (and their integer constants) are:
%   SampleRates         (65536) or (0x10000)
%   InputRanges         (131072) or (0x20000)
%   Impedances          (196608) or (0x30000)
%   Couplings           (262144) or (0x40000)
%   Modes               (327680) or (0x50000)
%   Terminations        (393216) or (0x60000)
%   FlexibleTrigger     (458752) or (0x70000)
%   BoardTriggerEngines (524288) or (0x80000)
%
