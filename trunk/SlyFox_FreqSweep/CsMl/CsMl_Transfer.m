...
% requirements in the driver. They are adjusted here so only good data is returned 
% in the buffer. If the mode of transfer was TimeStamp mode, the tick frequency used 
% is returned in the actual variable.
